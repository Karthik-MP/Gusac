            ...
            <?php
                    ...
                    ?>
                      <div class="card"  style="width: 18rem;">
                         <div class="circle align-self-center my-2 circular--portrait">
                          ...
                          ?>
                          <img class="profile-pic" src="uploads/profilephotos/<?php echo($rows['profile_pic']); ?>">
                          <?php
                          }
                          else{
                            ?>
                              <img class="profile-pic" src="https://t3.ftcdn.net/jpg/03/46/83/96/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg" id="profileImage">;
                              <?php
                          }
                          ?>
                             <!-- User Profile Image -->
                         ...
                         <form class="align-self-center" id="profilePicSave">
                           ...
                           <input type="submit" name=""  class="btn btn-primary" id="profSave" value="Save" />
                         </form>
                        <div class="card-body text-center">
                          <h3><?php echo $rows['first_name']." ". $rows['last_name']; ?></h3>
                          <?php
                            $query="select `team` from team_recruit where sid=$sid";
                            if($result=mysqli_query($con,$query)){
                              while($getTeam=$result ->fetch_row()){
                              ?>
                      ...
                      <div class="border rounded">
                         <div class="px-4 my-2">
                            <div class="d-flex flex-row my-2">
                               <h3>Details</h3>
                                  <button type="button" class="btn btn-primary ml-auto" data-toggle="modal" data-target="#modelEditProfile" onclick="fillForm()">Edit Profile</button>
                            </div>
              ...
              <div class="mt-3">
                <div class="d-flex flex-row">
                  ...
                  <input type="button" name="" class="ml-3 btn btn-primary ml-auto mr-3" value="Upload" />
                </div>
               <?php 
                  ...
                  while ($row=mysqli_fetch_array($check)) {
                    ?>
                     <div class="border rounded px-4 my-2">
                      <div class="d-flex flex-row my-2">
                         <h3><?php echo $row['project_name'];?></h3>
                         <div class="ml-auto mt-2">
                            <span class="customBox" >
                               <?php  if ($row['status']==1){echo "Approved"; }
                                      else if ($row['status']==-1) {echo "Rejected"; }
                                      else { echo "pending";}
                               ?>
                             </span>
                          </div>   
                      ...
                      <div class="row my-3">
                         <div class="col-md-6 text-center">
                            <img src="images/<?php echo $row['project_pic_path'];?>">
                         </div>
                         <div class="col-md-6">
                            ...
                            <?php echo $row['description'];?>.<br>
                               ...
                               <h6><b>Projects Link:</b></h6><a href="<?php echo $row['project_links'];?>"><h6> Click here</h6></a><br><br>
                            </div>
                         </div>
                      </div>
                   </div>
            ...
            <div class="modal-body">
               ...
               <!-- Message / status  -->
                  <!-- <h4 class="mt-4 text-center mb-4">Register to join the CLUB</h4> -->
                     ...
                     <div class="form-group">
                        <input type="number" class="form-control" id="mrNum" placeholder="Register number" disabled="">
                     </div>
                         <div class="form-group">
                            <div class="row">
                               <div class="col">
                     ...
                     <div class="text-center mt-4 mb-1">
                        <button type="" class="btn btn-primary" id="profilePageSave">Save</button>
                    </div>
                  </form>
