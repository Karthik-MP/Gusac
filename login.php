  ...
  <div class="border rounded col-md-4 mx-auto main">
    ...
    <form id="login_form">
      ...
      <div class="my-3">
        ...
        <input type="email" class="form-control" id="login_email" name="login_email" aria-describedby="SLemailHelp" placeholder="Email" required>
      ...
      <div class="mb-3 text-center">
         ...
         <input type="submit" class="btn btn-primary" id="loginButton" value="Login"/><br>



         <a href="#" data-toggle="modal" data-target="#forgotPmodal">Forgot Password?</a>
